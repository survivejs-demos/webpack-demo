...
exports.setupCSS = function setupCSS(path) {
  return {
    module: {
      loaders: [
        {
...
exports.dontParse = function dontParse(options) {
  const alias = {};
...
exports.setEnvironment = function setEnvironment(options) {
  const env = {};
...
exports.extractCSS = function extractCSS(path) {
  return {
    module: {
      loaders: [
